...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Fale com Lu Toledo no WhatsApp"
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-luxe transition-transform hover:scale-110"
